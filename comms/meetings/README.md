...
carried over directly from the sibling Voynich Collective project, whose
own steering-committee history (ten meetings before this project was
scaffolded) is what shaped items 5 and 6 into standing requirements. There
is no equivalent history here yet — items 5 and 6 should still genuinely
find nothing to report at Meeting #1, and that is the correct, honest
answer, not a sign the check is being skipped.
